          ...
          <ul v-else class="task-list" :class="SubStyle">
            <li v-for="(task, index) in tasks" :key="task.id">
              ...
              <div>
                ...
                <button class="btn btn_red " @click="removeTask(index)"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
